...
const WhatWeOffer = (props: Props) => {
  return (
    <div className="md:my-[12rem] my-32 ">
      <h1
        className="text-center md:text-4xl text-2xl font-extrabold text-gray-700 italic  tracking-widest"
      ...
      <div className="flex justify-center md:space-x-40 space-x-2 items-center mt-10">
        <span className="h-[10rem] w-[10rem] cursor-pointer ">
          <Image
            width={500}
            height={500}
          ...
          />
          <span className=" md:text-xs text-[0.6rem] text-red-900 font-extrabold">
        ...
        <span className="h-[10rem] w-[10rem] cursor-pointer ">
          <Image
            ...
            className="w-full h-full "
          />
          <span className="md:text-xs text-[0.6rem] text-blue-900 pt-4 font-extrabold">
            The platform provides real-time updates on class availability,
            ensuring users have the latest information.
          </span>
        </span>
      </div>
      <div className="md:flex md:justify-around  md:items-center gap-y-[10rem] grid grid-cols-2 mt-40">
        <span className="md:h-[10rem] md:w-[10rem] h-[7rem] w-[7rem] cursor-pointer ">
          <Image
            width={500}
            height={500}
            ...
            className="w-full h-full"
          />
          <span className=" md:text-xs text-[0.6rem] text-black font-extrabold">
        ...
        <span className="md:h-[10rem] md:w-[10rem] h-[10rem] w-[15rem] cursor-pointer ">
          <Image
            width={500}
            height={500}
      ...
      <div className="md:flex md:justify-center md:space-x-10 grid grid-cols-2 gap-y-32   md:items-center md:mt-20 mt-28 ">
        <span className="h-[10rem] w-[10rem]  cursor-pointer ">
          <Image
            width={500}
            height={500}
        ...
        <span className="md:h-[20rem] md:w-[20rem] h-[10rem] w-[10rem] cursor-pointer ">
          <Image
            ...
            className="w-full h-full rounded-full  "
          />
          <span className="md:text-xs text-[0.6rem] text-blue-900  font-extrabold">
            Users can provide feedback and ratings for classes and instructors,
            fostering a community-driven approach.
          </span>
        </span>

        <span className="h-[10rem] md:w-[10rem] w-[15rem] cursor-pointer ">
          <Image
            width={500}
            height={500}
